<footer class="bg-dark text-light text-center text-lg-unset fs-7">
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <h5 class="mb-3">Get In Touch</h5>
                <p class="mb-1">Eco Sanctuaries, Nacpan Beach, El Nido, Palawan, Philippines</p>
                <a href="#" class="d-block mb-1 text-beige">ecosanctuarieselnido@gmail.com</a>
            ...
            <div class="col-lg-6 mb-4 mb-lg-0">
                <ul class="nav flex-column flex-lg-row justify-content-lg-end gap-2 gap-lg-3 mb-4 mb-lg-2">
                    ...
                    <li class="nav-item"> <a href="#" class="nav-link text-light text-beige-hover p-0">Experiences</a> </li>
